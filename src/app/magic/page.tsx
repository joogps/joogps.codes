    ...
    <div className="flex flex-col items-center m-8 md:m-16 text-center space-y-8">
      <h3 className="font-bold text-5xl text-shadow">
        <span className="text-purple-600">
          M<span className="space-grotesk-alternate">a</span>gic
        </span>{" "}
        is the drawing app <br />
      ...
      <div className="flex flex-row space-x-4">
        <CapsuleButton
          ...
          href="https://apps.apple.com/app/apple-store/id1581223559?pt=122431166&ct=Website&mt=8"
        >
          <p className="py-2 px-5 text-nowrap"> get the app ↓ </p>
        </CapsuleButton>

        <CapsuleButton
          className="capsule-button-secondary-light"
          href="https://joogps.notion.site/Magic-765b88c426a740b88b30bbeb0d067017?pvs=4"
        >
