        ...
        <div className="flex flex-col bg-white dark:bg-zinc-950 p-12 md:my-24 text-xl sm:text-2xl font-semibold space-y-8 items-start md:max-w-[660px] md:mx-16 md:rounded-2xl md:border-2 border-stone-200 dark:border-zinc-800">
          ...
          <p>
            ...
            <span className="opacity-85">
              <ArrowLink
                href="https://push.joogps.com"
                className="expanded-font"
              >
                push
              </ArrowLink>
          ...
          <p>
            ...
            <ArrowLink href="https://instagram.com/joogps">
              {" "}
              Instagram{" "}
            </ArrowLink>
            , <ArrowLink href="https://github.com/joogps">
              {" "}
              GitHub{" "}
            </ArrowLink>,{" "}
            <ArrowLink href="https://linkedin.com/in/joogps/">
              {" "}
              LinkedIn{" "}
            </ArrowLink>{" "}
            and{" "}
